...
export const ModalResenas = ({ planEmpresa, onClose }) => {
  ...
  const obtenerNombreCliente = (clienteId) => {
    // Aquí podrías hacer una llamada al backend para obtener el nombre del cliente
            ...
            {cargando && resenas.length === 0 ? (
              ...
              resenas.map((resena) => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center text-white font-semibold">
                        {obtenerNombreCliente(resena.clienteId)
                          .charAt(0)
                          .toUpperCase()}
                      </div>
                      <div>
                  ...
                  {resena.comentario && (
                    <p className="text-gray-700 mt-2">{resena.comentario}</p>
                  )}
                </div>
              ))
            )}
